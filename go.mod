...
require (
	...
	github.com/quasilyte/go-ruleguard v0.3.19-0.20221228183442-c18ffba1bff0 // indirect
	github.com/quasilyte/gogrep v0.0.0-20221002170852-631b4cfd0c04 // indirect
