...
There is also a [Drone Plugin](https://github.com/rancherlabs/drone-plugin-golangci-lint) for running `golangci-lint` in CI for several different Source Control Management providers.
