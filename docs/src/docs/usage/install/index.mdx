...
### Install via [Cask](https://github.com/axetroy/cask.rs)

You can install via Cask, and it supports cross-platform

```bash
cask install github.com/golangci/golangci-lint
```
