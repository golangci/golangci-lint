...
Or you can create a [GitHub Issue](https://github.com/anduril/golangci-lint/issues/new) and we will integrate when time permits.
...
go1.18+ is officially supported, with some [limitations](https://github.com/anduril/golangci-lint/issues/2649), since golangci-lint v1.45.0.

## `golangci-lint` doesn't work

1. Please, ensure you are using the latest binary release.
2. Run it with `-v` option and check the output.
3. If it doesn't help create a [GitHub issue](https://github.com/anduril/golangci-lint/issues/new) with the output from the error and #2 above.
