...
There is a [`.golangci.example.yml`](https://github.com/anduril/golangci-lint/blob/master/.golangci.example.yml) example
...
It's a [.golangci.yml](https://github.com/anduril/golangci-lint/blob/master/.golangci.yml) config file of this repo: we enable more linters
