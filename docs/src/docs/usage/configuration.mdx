...
There is a [`.golangci.reference.yml`](https://github.com/anduril/golangci-lint/blob/master/.golangci.reference.yml) file with all supported options, their description, and default values.
