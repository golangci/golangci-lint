...
![Build Status](https://github.com/anduril/golangci-lint/workflows/CI/badge.svg)
[![License](https://img.shields.io/github/license/golangci/golangci-lint)](https://github.com/anduril/golangci-lint/blob/master/LICENSE)
[![Release](https://img.shields.io/github/release/golangci/golangci-lint.svg)](https://github.com/anduril/golangci-lint/releases/latest)
...
[![golangci-lint contributors](https://contributors-img.web.app/image?repo=golangci/golangci-lint)](https://github.com/anduril/golangci-lint/graphs/contributors)
