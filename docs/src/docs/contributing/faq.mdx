...
Add a new field to a [config struct](https://github.com/anduril/golangci-lint/blob/master/pkg/config/config.go).
Document it in [.golangci.reference.yml](https://github.com/anduril/golangci-lint/blob/master/.golangci.reference.yml).
Pass it to a linter.
