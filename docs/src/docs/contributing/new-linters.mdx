...
4. Find out what options do you need to configure for the linter.
   For example, `nakedret` has only 1 option: [`max-func-lines`](https://github.com/anduril/golangci-lint/blob/master/.golangci.example.yml).
   Choose default values to not being annoying for users of golangci-lint. Add configuration options to:
    - [.golangci.example.yml](https://github.com/anduril/golangci-lint/blob/master/.golangci.example.yml) - the example of a configuration file.
