...
5. You can add your linter to lint golangci-lint codebase. [.golangci.yml](https://github.com/golangci/golangci-lint/blob/master/.golangci.yml).
   You have to comment out in this PR. CI fails if enable your new linter. Github Actions uses latest release version which doesn't have your new linter.
...
6. Take a look at the example of [Pull Request with new linter support](https://github.com/golangci/golangci-lint/pull/850).
