...
We have [good issues for first-time contributing](https://github.com/anduril/golangci-lint/issues?q=is%3Aopen+label%3A%22good+first+issue%22+sort%3Areactions-%2B1-desc).
