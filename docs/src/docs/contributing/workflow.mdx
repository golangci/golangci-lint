...
conduct](https://github.com/anduril/golangci-lint/blob/master/CODE_OF_CONDUCT.md).
...
Fork and clone [golangci-lint](https://github.com/anduril/golangci-lint) repository.
...
Also, we run a few checks in CI by using GitHub actions, you can see them [here](https://github.com/anduril/golangci-lint/blob/master/.github/workflows/pr.yml).
...
A GitHub action [workflow](https://github.com/anduril/golangci-lint/blob/master/.github/workflows/tag.yml) will start building and publishing release after that.

After making a release you need to update:

1. GitHub [action config](https://github.com/anduril/golangci-lint/blob/master/assets/github-action-config.json) by running:
