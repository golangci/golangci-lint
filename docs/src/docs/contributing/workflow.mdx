...
## Update golangci-lint version to lint golangci-lint codebase

[.github/workflows/pr.yml](https://github.com/golangci/golangci-lint/blob/master/.github/workflows/pr.yml)

## Enable new linters to lint golangci-lint codebase

[.golangci.yml](https://github.com/golangci/golangci-lint/blob/master/.golangci.yml)
