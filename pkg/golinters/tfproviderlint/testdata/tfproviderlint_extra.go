//golangcitest:config_path testdata/tfproviderlint_extra.yml
...
func _() {
	...
	d.HasChanges("attr1", "attr2", "attr3")
...
func _() {
	...
	d.GetOkExists("test") // want `XR001: ResourceData\.GetOkExists\(\) call should be avoided`
}
